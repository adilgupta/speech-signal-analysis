...
if __name__ == '__main__':
    for n_type in noise_types = ['rain', 'babble', 'childrenPlaying', 'wind']:
        ...
        print(np.sum(np.square(frequency_enhanced-frequency_clean)))
        print(np.sum(np.square(frequency_noisy-frequency_clean)))
        print(np.sum(np.square(frequency_enhanced-frequency_clean))/np.sum(np.square(frequency_noisy-frequency_clean)))
